...
def main():
    ...
    # my subs
    for s, path in zip([0.9499, 0.9515], my_subs):
        scores.append(s)
    ...
    if not os.path.exists('../data/output/stack_gmean_010'):
        os.makedirs('../data/output/stack_gmean_010')
    concat_sub[['isFraud']].to_csv('../data/output/stack_gmean_010/submission.csv')
